...
- **`docs/design/applied-app.jpeg`** — **적용 화면 목업**(Apple 구조 + 홍시 퍼시먼, 6화면). ⚠️ 제안 라벨 배지 색은 이 목업에서 퍼시먼 채움/아웃라인으로 그려졌으나 **비정본** — 정본은 `DESIGN.md` §2 시맨틱 토큰(그린/그레이/앰버, 결정 #29). 재렌더 follow-up #32.
