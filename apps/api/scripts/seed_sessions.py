...
#
# 사용법 (apps/api에서, Settings 필수 env 3종이 공급된 상태로 — 절차는 docs/pilot/api-cutover-smoke.md).
# 3종 = DATABASE_URL·SESSION_SECRET·GEMINI_API_KEY. IdP 4개는 Optional이라 이 스크립트와 무관하다(#163)
# — 참조 문서가 아직 IdP 변수를 export하고 있으면 낡은 것이다(정리는 #167·#169).
